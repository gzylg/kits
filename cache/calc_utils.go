...
var (
	ErrIncrementOverflow = errs.New("this incr invocation will overflow.")
	ErrDecrementOverflow = errs.New("this decr invocation will overflow.")
	ErrNotIntegerType    = errs.New("item val is not (u)int (u)int32 (u)int64")
)
