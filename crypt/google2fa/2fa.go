...
func (m *GoogleAuthenticator2FaSha1) Totp() (string, error) {
	...
	if err != nil {
		return "", errs.New("https://github.com/google/google-authenticator/wiki/Key-Uri-Format,REQUIRED: The base32NoPaddingEncodedSecret parameter is an arbitrary key value encoded in Base32 according to RFC 3548. The padding specified in RFC 3548 section 2.2 is not required and should be omitted.")
	}

	var codeInt int
	if codeInt, err = hotp(key, count, m.Digits); err != nil {
		return "", err
	}
